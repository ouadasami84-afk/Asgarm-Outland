  ...
  return (
    <section className="relative h-screen w-full flex flex-col items-center justify-end overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center w-full pb-20 max-w-5xl px-6">
        ...
        >
          <button className="group relative px-12 py-5 bg-gold text-night font-bold text-[10px] tracking-[0.5em] uppercase transition-all hover:scale-105 shadow-[0_0_50px_rgba(212,175,55,0.3)] border border-gold/30">
