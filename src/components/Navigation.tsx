...
export const Navigation: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-[60] transition-all duration-700 ease-in-out border-none outline-none shadow-none ring-0 ${
      scrolled ? 'h-16 bg-black/95 backdrop-blur-3xl' : 'h-24 bg-transparent'
    }`}>
      <div className="max-w-7xl mx-auto h-full px-8 flex items-center justify-between border-none outline-none shadow-none ring-0">
