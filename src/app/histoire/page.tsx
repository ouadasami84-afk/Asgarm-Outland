        ...
        >
          <div className="flip-book-container relative shadow-[0_60px_120px_rgba(0,0,0,1)] border-[2px] border-[#1a120a] rounded-sm overflow-hidden bg-[#2a1a0a]">
            ...
            >
              {/* Chapitre 1 */}
              <Page number={1}>
                <h2 className="text-xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-6 text-center border-b border-[#4a3721]/10 pb-4">Chapitre 1</h2>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-sm">
              ...
              {/* Chapitre 2 */}
              <Page number={2}>
                <h2 className="text-xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-6 text-center border-b border-[#4a3721]/10 pb-4">Chapitre 2</h2>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-sm">
              ...
              {/* Chapitre 3 */}
              <Page number={3}>
                <h2 className="text-xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-6 text-center border-b border-[#4a3721]/10 pb-4">Chapitre 3</h2>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-sm">
              ...
              {/* Chapitre 4 */}
              <Page number={4}>
                <h2 className="text-xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-6 text-center border-b border-[#4a3721]/10 pb-4">Chapitre 4</h2>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-sm">
              ...
              {/* Chapitre 5 */}
              <Page number={5}>
                <h2 className="text-xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-6 text-center border-b border-[#4a3721]/10 pb-4">Chapitre 5</h2>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-sm">
              ...
              {/* Chapitre 6 */}
              <Page number={6}>
                <h2 className="text-xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-6 text-center border-b border-[#4a3721]/10 pb-4">Chapitre 6</h2>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-sm">
              ...
              {/* Chapitre 7 */}
              <Page number={7}>
                <h2 className="text-xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-6 text-center border-b border-[#4a3721]/10 pb-4">Chapitre 7</h2>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-sm">
              ...
              {/* Chapitre 8 */}
              <Page number={8}>
                <h2 className="text-xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-6 text-center border-b border-[#4a3721]/10 pb-4">Chapitre 8</h2>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-sm">
              ...
              {/* Chapitre 9 */}
              <Page number={9}>
                <h2 className="text-xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-6 text-center border-b border-[#4a3721]/10 pb-4">Chapitre 9</h2>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-sm">
                ...
                <div className="h-full flex flex-col pt-2">
                  ...
                  {!lore ? (
                    <div className="flex flex-col gap-4 flex-1">
                      ...
                      <textarea
                        className="w-full flex-1 bg-black/[0.03] border border-[#4a3721]/15 p-5 text-[#3d2b19] focus:border-[#4a3721]/30 outline-none resize-none font-serif text-sm leading-relaxed shadow-inner placeholder-[#4a3721]/20"
                      ...
                      <button
                        ...
                        className="w-full py-4 bg-[#2a1a0a] text-gold font-bold uppercase tracking-[0.8em] text-[10px] flex items-center justify-center gap-4 hover:bg-[#1a0f05] transition-all disabled:opacity-20 border border-gold/10 group/btn"
                      >
                    ...
                    <div className="flex flex-col h-full">
                      <div className="flex-1 overflow-y-auto pr-4 custom-scrollbar mb-4">
                        <p className="text-[#3d2b19] text-xs leading-relaxed italic font-serif opacity-90 text-justify border-l border-[#4a3721]/10 pl-5">
                          {lore}
                        </p>
                      </div>
                      <button 
