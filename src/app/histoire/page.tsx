...
const HISTORY_DATA = [
  ...
  },
  {
    ...
    chapters: [
      ...
      { title: "Les Enfants des Montagnes", content: "À l'est d'Asgarm, sous les sommets enneigés des Montagnes Grises, une autre civilisation prenait forme. Les Nains. Leurs origines demeurent mystérieuses. Certaines légendes affirment qu'ils furent façonnés directement par les Titans de pierre. D'others racontent qu'ils émergèrent des profondeurs de la terre elle-même. Quelle que soit la vérité, une chose était certaine. Les Nains étaient différents. Ils ne recherchaient pas les vastes royaumes. Ils ne rêvaient pas de conquêtes. Ils construisaient. Ils forgeaient. Ils créaient. Leur premier royaume fut Khaz'Tor. Une immense cité souterraine creusée au cœur d'une montagne gigantesque. Ses galeries s'étendaient sur des centaines de kilomètres. Ses forges brûlantes créaient déjà des œuvres impossibles à reproduire. Rapidement, les Nains gagnèrent une réputation unique. Ils étaient les meilleurs bâtisseurs du monde." },
  ...
  },
  {
    ...
    chapters: [
      ...
      { title: "Le Secret des Premiers Elfes", content: "Ce soir-là, Melfetys révéla un secret gardé depuis des milliers d'années. Un secret connu uniquement des souverains elfes. La magie n'avait jamais réellement appartenue aux Elfes. Ils n'en étaient que les gardiens. Depuis les premiers âges du monde, les Elfes protégeaient l'Essence Arcannique. Une source de pouvoir immense. Une énergie capable d'éveiller la magie chez n'importe quel être vivant. Les anciens souverains avaient juré de ne jamais la libérer. Mais désormais... Le choix n'existait plus." },
  ...
  },
  {
    ...
    chapters: [
      { title: "L'Éveil d'une Génération", content: "Le sacrifice de Melfetys avait changé le monde. Partout à travers Asgarm, des milliers d'individus découvraient leurs nouveaux pouvoirs. Certains furent terrifiés. D'others fascinés. Beaucoup périrent en tentant de maîtriser des forces qu'ils ne comprenaient pas. La magie était un don. Mais également un danger. Les premiers mois furent chaotiques. Pourtant, au milieu de ce désordre, des figures exceptionnelles commencèrent à émerger. Des individus capables non seulement d'utiliser la magie... Mais de la comprendre. Et de la maîtriser." },
      ...
      { title: "Les Années de Feu", content: "Les années suivantes furent les plus violentes de toute l'histoire d'Asgarm. Des batailles éclatèrent sur chaque frontière. Des héros émergèrent. D'others tombèrent. Les pertes étaient terribles. Mais contrairement aux premières années de guerre, les royaumes résistaient. Chaque victoire renforçait leur confiance. Peu à peu, les Cavaliers cessèrent d'avancer. Pour la première fois. Ils étaient bloqués." },
  ...
  },
  {
    ...
    chapters: [
      ...
      { title: "Héritiers de la Guerre", content: "Une nouvelle génération de sorciers dominaient désormais Asgarm. Ils n'avaient pas connu l'invasion. Pour beaucoup d'entre eux, la magie représentait simplement un outil. Une ressource pour obtenir richesse ou influence. Cette différence inquiétait les anciens survivants. Car ils savaient ce que pouvait devenir un sorcier lorsqu'il oubliait les leçons du sang et des larmes." },
...
const MagicalText = ({ text, title, tome, isBigger }: { text: string; title?: string; tome?: string; isBigger?: boolean }) => {
  ...
  return (
    <div className="flex flex-col h-full">
      {tome && (
        <span className={`${isBigger ? 'text-[10px]' : 'text-[8px]'} text-[#b48d1d]/60 font-bold tracking-[0.4em] uppercase mb-1`}>
          {tome}
        </span>
      )}
      {title && (
        <motion.h3 
          ...
          className={`${isBigger ? 'text-[18px]' : 'text-[14px]'} font-headline text-[#4a3721] mb-4 tracking-tight border-b border-[#4a3721]/15 pb-2 uppercase`}
        >
          {title}
        </motion.h3>
      )}
      <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar-inner">
        <motion.p className={`${isBigger ? 'text-[13px]' : 'text-[10px]'} text-[#3d2b19] font-serif leading-[1.6] text-justify italic`}>
          {words.map((word, i) => (
            <span
              key={i}
