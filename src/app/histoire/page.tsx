  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1">
        <motion.p className="text-[#3d2b19] font-serif leading-[1.8] text-justify text-[12px] italic">
          {words.map((word, i) => (
            <motion.span
              key={i}
  ...
  return (
    <main className="relative min-h-screen flex flex-col overflow-hidden bg-transparent">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 pt-32 pb-8 relative z-10">
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2 }} className="text-center mb-12">
          ...
          <h1 className="text-5xl font-headline uppercase tracking-tighter mb-4 leading-tight shine-text">
            Les Annales de la Souveraineté
          </h1>
          <span className="shine-text text-[11px] tracking-[0.6em] uppercase font-bold opacity-60">Faites glisser les pages pour explorer les annales</span>
        </motion.div>
      ...
      <footer className="h-20 border-t border-gold/10 flex items-center justify-center bg-black/60 relative z-20 w-full mt-auto">
        <span className="shine-text text-[11px] tracking-[0.8em] uppercase font-bold">CONCLAVE SUPRÊME — ÉQUILIBRE D'ASGARM V3.1</span>
      </footer>
