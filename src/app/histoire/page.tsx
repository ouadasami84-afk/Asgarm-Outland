    ...
    <main className="relative min-h-screen flex flex-col overflow-hidden bg-transparent">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 pt-32 pb-8 relative z-10">
            ...
            >
              ...
              <Page number={1}>
                <div className="h-full flex flex-col items-center pt-8 px-12">
                  <h2 className="text-sm font-headline text-[#4a3721] uppercase tracking-[0.6em] mb-12 border-b border-[#4a3721]/15 pb-4 w-full text-center">Sommaire des Annales</h2>
                  <div className="flex flex-col gap-3 w-full">
                    {chapters.map((ch, i) => (
                      <div key={i} className="flex items-baseline justify-between group cursor-pointer py-1.5" onClick={() => bookRef.current.pageFlip().flip(ch.page - 1)}>
                        <span className="text-[11px] font-serif uppercase tracking-[0.25em] text-[#4a3721]/80 group-hover:text-gold transition-colors">{ch.title}</span>
        ...
        >
          ...
          <span className="text-gold text-[10px] tracking-[0.8em] uppercase font-bold text-glow-gold">
