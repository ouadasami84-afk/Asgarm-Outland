    ...
    <div className="flex flex-col h-full">
      {title && (
        <motion.h3 
          ...
          className="text-lg font-headline text-[#4a3721] mb-4 tracking-tight border-b border-[#4a3721]/15 pb-2"
        >
          {title}
        </motion.h3>
      )}
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 pt-32 pb-8 relative z-10">
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-2">
            <div className="h-[1px] w-12 bg-gold/20 shadow-[0_0_15px_rgba(212,175,55,0.4)]" />
        ...
        >
          ...
          <div className="absolute inset-[-40px] bg-indigo-950/40 blur-[120px] rounded-full animate-pulse" />
          ...
          <div className="flip-book-container relative shadow-[0_50px_120px_rgba(0,0,0,0.95)] border-[3px] border-[#1a120a] rounded-sm overflow-hidden bg-[#2a1a0a] ring-2 ring-gold/10">
            ...
            >
              ...
              <Page number={1}>
                <div className="h-full flex flex-col items-center pt-8 px-12">
                  <h2 className="text-lg font-headline text-[#4a3721] uppercase tracking-[0.4em] mb-12 border-b border-[#4a3721]/15 pb-3 w-full text-center">Sommaire des Annales</h2>
                  <div className="flex flex-col gap-3 w-full">
                    {chapters.map((ch, i) => (
                      <div 
                        key={i} 
                        className="flex items-baseline justify-between group cursor-pointer py-2 border-b border-[#4a3721]/5 hover:bg-[#4a3721]/5 transition-all px-2" 
                  ...
                  <div className="mt-auto pb-6">
                    <div className="flex flex-col items-center gap-3">
                      <div className="h-[1.5px] w-12 bg-gold/30" />
                      <p className="text-[#4a3721]/40 text-[9px] uppercase tracking-[0.6em] italic font-bold">Archives Royales d'Asgarm</p>
                    </div>
                  </div>
                </div>
              </Page>
              ...
              <Page number={2}>
                <div className="px-10 pt-4 h-full">
        ...
        >
          <div className="h-[1px] w-20 bg-gold/30 shadow-[0_0_15px_rgba(212,175,55,0.4)]" />
