    ...
    <div className="page shadow-2xl" ref={ref}>
      <div className="page-content">
        <div className="page-inner-content relative z-10 flex flex-col h-full">
          {children}
          {number && (
            <div className="page-footer font-serif italic text-[#4a3721]/30 text-[10px] tracking-[0.4em] mt-auto pt-6 text-center border-t border-[#4a3721]/5">
              — {number} —
            </div>
          )}
        </div>
  ...
  return (
    <main className="relative min-h-screen flex flex-col overflow-hidden bg-transparent">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 pt-32 pb-12 relative z-10">
        ...
        >
          <div className="flip-book-container relative shadow-[0_40px_100px_rgba(0,0,0,0.8)] border-[3px] border-[#1a120a] rounded-sm overflow-hidden bg-[#2a1a0a]">
            <HTMLFlipBook
              width={600}
              height={820}
              size="stretch"
            ...
            >
              ...
              <Page number={1}>
                <div className="h-full flex flex-col items-center pt-8">
                  <BookIcon className="w-8 h-8 text-[#4a3721]/20 mb-8" />
                  <h2 className="text-xl font-headline text-[#4a3721] uppercase tracking-[0.4em] mb-12 border-b border-[#4a3721]/10 pb-6 w-full text-center">Sommaire</h2>
                  <div className="flex flex-col gap-6 w-full px-6">
                    {chapters.map((ch, i) => (
                      <div key={i} className="flex items-baseline justify-between group cursor-pointer" onClick={() => bookRef.current.pageFlip().flip(ch.page - 1)}>
                        <span className="text-[11px] font-serif uppercase tracking-widest text-[#4a3721]/60 group-hover:text-[#4a3721] transition-colors">{ch.title}</span>
                        <div className="flex-1 border-b border-dotted border-[#4a3721]/10 mx-4" />
                        <span className="text-[11px] font-serif text-[#4a3721]/40">{ch.page}</span>
                      </div>
                    ))}
                  </div>
                  <div className="mt-auto pb-12">
                    <p className="text-[#4a3721]/30 text-[9px] uppercase tracking-[0.5em] italic">Archives Royales d'Asgarm</p>
                  </div>
                </div>
              </Page>
              ...
              {/* Chapitre 2 */}
              <Page number={3}>
                <h2 className="text-sm font-headline text-[#4a3721]/60 uppercase tracking-[0.4em] mb-8 border-b border-[#4a3721]/5 pb-4">Chapitre II</h2>
                <h3 className="text-lg font-headline text-[#4a3721] mb-6">L'Invasion Abyssale</h3>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-[13px]">
              ...
              {/* Chapitre 3 */}
              <Page number={4}>
                <h2 className="text-sm font-headline text-[#4a3721]/60 uppercase tracking-[0.4em] mb-8 border-b border-[#4a3721]/5 pb-4">Chapitre III</h2>
                <h3 className="text-lg font-headline text-[#4a3721] mb-6">Le Sacrifice de Melfetys</h3>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-[13px]">
              ...
              {/* Chapitre 4 */}
              <Page number={5}>
                <h2 className="text-sm font-headline text-[#4a3721]/60 uppercase tracking-[0.4em] mb-8 border-b border-[#4a3721]/5 pb-4">Chapitre IV</h2>
                <h3 className="text-lg font-headline text-[#4a3721] mb-6">L'Éveil des Humains</h3>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-[13px]">
              ...
              {/* Chapitre 5 */}
              <Page number={6}>
                <h2 className="text-sm font-headline text-[#4a3721]/60 uppercase tracking-[0.4em] mb-8 border-b border-[#4a3721]/5 pb-4">Chapitre V</h2>
                <h3 className="text-lg font-headline text-[#4a3721] mb-6">La Forge des Nains</h3>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-[13px]">
              ...
              {/* Chapitre 6 */}
              <Page number={7}>
                <h2 className="text-sm font-headline text-[#4a3721]/60 uppercase tracking-[0.4em] mb-8 border-b border-[#4a3721]/5 pb-4">Chapitre VI</h2>
                <h3 className="text-lg font-headline text-[#4a3721] mb-6">Le Serment de Sang</h3>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-[13px]">
                  Les Vampires du Domaine Carmin, dirigés par le noble et énigmatique Lord Valerius, découvrirent que leur affinité innée avec le sang pouvait être canalisée à travers des baguettes. Au lieu de prendre la vie, ils apprirent à la manipuler pour la restaurer. Ils devinrent les plus grands guérisseurs de guerre, capables de refermer les blessures les plus mortelles par des sortilèges de sang complexes, des anges improbables sur un champ de bataille infernal. Leur intervention changea le cours de nombreuses batailles, sauvant d'innombrables vies et forgeant leur nouvelle réputation de sauveurs inattendus, loin des mythes de prédateurs solitaires.
                </p>
              </Page>

              {/* Chapitre 7 */}
              <Page number={8}>
                <h2 className="text-sm font-headline text-[#4a3721]/60 uppercase tracking-[0.4em] mb-8 border-b border-[#4a3721]/5 pb-4">Chapitre VII</h2>
                <h3 className="text-lg font-headline text-[#4a3721] mb-6">L'Alliance de la Lumière</h3>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-[13px]">
                  C'est ainsi que naquit l'Alliance de la Lumière. Les armées humaines affrontaient les ténèbres avec des volées de sortilèges. Les légions de Nains, équipées des puissantes baguettes de Thorgrim, étaient des remparts infranchissables. Les Vampires de Valerius maintenaient les troupes en vie, tandis que les Elfes de Lune, maîtres de la magie de l'ombre, utilisaient leurs propres baguettes pour frapper en silence au cœur des lignes ennemies. Unis par le désespoir et l'espoir, ces peuples autrefois divisés se battaient enfin comme un seul homme pour la survie d'Asgarm, une fraternité forgée dans le feu du combat.
                </p>
              </Page>

              {/* Chapitre 8 */}
              <Page number={9}>
                <h2 className="text-sm font-headline text-[#4a3721]/60 uppercase tracking-[0.4em] mb-8 border-b border-[#4a3721]/5 pb-4">Chapitre VIII</h2>
                <h3 className="text-lg font-headline text-[#4a3721] mb-6">Le Crépuscule des Cavaliers</h3>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-[13px]">
                  La guerre changea de visage. L'avancée des Cavaliers fut stoppée dans le sang et la cendre. La bataille finale eut lieu sur les Plaines Calcinées. Le Seigneur des Cavaliers affronta Alaric en duel. Alors que le roi humain était sur le point de succomber, Thorgrim le Nain s'interposa, son corps encaissant un sort mortel. Ce sacrifice héroïque offrit au roi une précieuse seconde. D'un cri de rage, il canalisa toute sa puissance dans sa baguette de chêne et déchaîna un sort qui anéantit le tyran. Les Cavaliers étaient vaincus, mais la faille dans le ciel demeurait, une blessure béante prête à tout consumer si l'équilibre n'était pas restauré.
                </p>
              </Page>

              {/* Chapitre 9 */}
              <Page number={10}>
                <h2 className="text-sm font-headline text-[#4a3721]/60 uppercase tracking-[0.4em] mb-8 border-b border-[#4a3721]/5 pb-4">Chapitre IX</h2>
                <h3 className="text-lg font-headline text-[#4a3721] mb-6">Le Nouvel Équilibre</h3>
                <p className="text-[#3d2b19] first-letter:text-5xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-relaxed text-justify text-[13px]">
                  La guerre était gagnée, mais le monde était fracturé. Sans la sagesse millénaire des Elfes pour les guider, beaucoup de nouveaux manieurs de magie furent séduits par la puissance brute. De cette ambition naquit le Conclave des Ombres, un royaume du mal cherchant à achever ce que les envahisseurs avaient commencé. Pour contrer cette menace, l'Académie d'Asgarm et le Conclave des Arcanes furent fondés : l'un pour enseigner, l'autre pour faire respecter la loi. Un nouvel équilibre s'est installé. L'Académie forme une nouvelle génération, espérant qu'ils choisiront la lumière. Les pages de ce grimoire s'arrêtent ici, car c'est à vous, héros d'Asgarm, d'écrire la suite.
                </p>
              </Page>
                ...
                <div className="h-full flex flex-col pt-4">
                  ...
                  {!lore ? (
                    <div className="flex flex-col gap-6 flex-1">
                      <p className="text-[#4a3721]/70 text-[11px] leading-relaxed italic text-center px-4 font-serif">
                        "Énoncez vos intentions pour que les archives révèlent un fragment de votre destinée personnelle au sein d'Asgarm..."
                      </p>
                      <textarea
                        className="w-full flex-1 bg-black/[0.02] border border-[#4a3721]/10 p-5 text-[#3d2b19] focus:border-[#4a3721]/20 outline-none resize-none font-serif text-sm leading-relaxed placeholder-[#4a3721]/20"
                      ...
                      <button
                        ...
                        className="w-full py-5 bg-[#2a1a0a] text-gold font-bold uppercase tracking-[0.8em] text-[10px] flex items-center justify-center gap-4 hover:bg-[#1a0f05] transition-all disabled:opacity-20 border border-gold/10"
                      >
                    ...
                    <div className="flex flex-col h-full">
                      <div className="flex-1 overflow-y-auto pr-4 custom-scrollbar mb-4">
                        <p className="text-[#3d2b19] text-[13px] leading-relaxed italic font-serif opacity-90 text-justify border-l border-[#4a3721]/10 pl-5">
                          {lore}
                        </p>
                      </div>
                      <button 
