...
const Page = forwardRef<HTMLDivElement, { children: React.ReactNode; number?: number }>(
  ({ children, number }, ref) => (
    <div className="page shadow-2xl relative" ref={ref}>
      ...
      <div className="absolute inset-4 border border-[#4a3721]/10 pointer-events-none z-20" />
      <div className="absolute inset-5 border-[0.5px] border-gold/10 pointer-events-none z-20" />
      ...
      <div className="page-content relative z-10">
        <div className="page-inner-content flex flex-col h-full">
          {children}
          {number && (
            <div className="page-footer font-serif italic text-[#4a3721]/40 text-[9px] tracking-[0.4em] mt-auto pt-4 text-center">
              — {number} —
            </div>
          )}
        </div>
    ...
    <main className="relative min-h-screen flex flex-col overflow-hidden bg-transparent">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 pt-32 pb-12 relative z-10">
        ...
        >
          ...
          <p className="text-gold/80 text-[11px] italic font-medium tracking-[0.15em] max-w-2xl mx-auto leading-relaxed text-glow-gold">
            "Le savoir d'Asgarm est scellé dans ce grimoire éternel. Tournez les pages pour explorer les racines de notre destin."
          </p>
        </motion.div>

        {/* Le Grimoire avec lueur magique */}
        <motion.div 
          ...
          className="relative"
        >
          {/* Lueur d'arrière-plan magique */}
          <div className="absolute inset-0 bg-gold/5 blur-[100px] rounded-full animate-pulse" />
          
          <div className="flip-book-container relative shadow-[0_40px_100px_rgba(0,0,0,0.8)] border-[3px] border-[#1a120a] rounded-sm overflow-hidden bg-[#2a1a0a] ring-1 ring-gold/10">
            <HTMLFlipBook
              width={600}
              height={850}
              size="stretch"
            ...
            >
              {/* Page de Sommaire */}
              <Page number={1}>
                <div className="h-full flex flex-col items-center pt-8 px-8">
                  <div className="w-12 h-12 rounded-full border border-gold/20 flex items-center justify-center mb-6 bg-gold/[0.02]">
                    <BookIcon className="w-5 h-5 text-gold/40" />
                  </div>
                  <h2 className="text-sm font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-10 border-b border-[#4a3721]/10 pb-4 w-full text-center">Sommaire des Annales</h2>
                  <div className="flex flex-col gap-3 w-full">
                    {chapters.map((ch, i) => (
                      <div key={i} className="flex items-baseline justify-between group cursor-pointer py-1.5" onClick={() => bookRef.current.pageFlip().flip(ch.page - 1)}>
                        ...
                        <div className="flex-1 border-b border-dotted border-[#4a3721]/15 mx-3" />
              ...
              <Page number={2}>
                <div className="px-6">
                  <h2 className="text-[9px] font-headline text-gold/60 uppercase tracking-[0.4em] mb-4 border-b border-gold/10 pb-2">Chapitre I</h2>
                  <h3 className="text-base font-headline text-[#4a3721] mb-6 tracking-tight">L'Âge d'Harmonie</h3>
                  <p className="text-[#3d2b19] first-letter:text-4xl first-letter:font-headline first-letter:mr-3 first-letter:float-left first-letter:text-gold first-letter:leading-none font-serif leading-relaxed text-justify text-[11px] italic">
              ...
              <Page number={3}>
                <div className="px-6">
                  <h2 className="text-[9px] font-headline text-gold/60 uppercase tracking-[0.4em] mb-4 border-b border-gold/10 pb-2">Chapitre II</h2>
                  <h3 className="text-base font-headline text-[#4a3721] mb-6 tracking-tight">L'Invasion Abyssale</h3>
                  <p className="text-[#3d2b19] first-letter:text-4xl first-letter:font-headline first-letter:mr-3 first-letter:float-left first-letter:text-gold first-letter:leading-none font-serif leading-relaxed text-justify text-[11px] italic">
              ...
              <Page number={4}>
                <div className="px-6">
                  <h2 className="text-[9px] font-headline text-gold/60 uppercase tracking-[0.4em] mb-4 border-b border-gold/10 pb-2">Chapitre III</h2>
                  <h3 className="text-base font-headline text-[#4a3721] mb-6 tracking-tight">Le Sacrifice de Melfetys</h3>
                  <p className="text-[#3d2b19] first-letter:text-4xl first-letter:font-headline first-letter:mr-3 first-letter:float-left first-letter:text-gold first-letter:leading-none font-serif leading-relaxed text-justify text-[11px] italic">
              ...
              <Page number={5}>
                <div className="px-6">
                  <h2 className="text-[9px] font-headline text-gold/60 uppercase tracking-[0.4em] mb-4 border-b border-gold/10 pb-2">Chapitre IV</h2>
                  <h3 className="text-base font-headline text-[#4a3721] mb-6 tracking-tight">L'Éveil des Humains</h3>
                  <p className="text-[#3d2b19] first-letter:text-4xl first-letter:font-headline first-letter:mr-3 first-letter:float-left first-letter:text-gold first-letter:leading-none font-serif leading-relaxed text-justify text-[11px] italic">
              ...
              <Page number={6}>
                <div className="px-6">
                  <h2 className="text-[9px] font-headline text-gold/60 uppercase tracking-[0.4em] mb-4 border-b border-gold/10 pb-2">Chapitre V</h2>
                  <h3 className="text-base font-headline text-[#4a3721] mb-6 tracking-tight">La Forge des Nains</h3>
                  <p className="text-[#3d2b19] first-letter:text-4xl first-letter:font-headline first-letter:mr-3 first-letter:float-left first-letter:text-gold first-letter:leading-none font-serif leading-relaxed text-justify text-[11px] italic">
              ...
              <Page number={7}>
                <div className="px-6">
                  <h2 className="text-[9px] font-headline text-gold/60 uppercase tracking-[0.4em] mb-4 border-b border-gold/10 pb-2">Chapitre VI</h2>
                  <h3 className="text-base font-headline text-[#4a3721] mb-6 tracking-tight">Le Serment de Sang</h3>
                  <p className="text-[#3d2b19] first-letter:text-4xl first-letter:font-headline first-letter:mr-3 first-letter:float-left first-letter:text-gold first-letter:leading-none font-serif leading-relaxed text-justify text-[11px] italic">
              ...
              <Page number={8}>
                <div className="px-6">
                  <h2 className="text-[9px] font-headline text-gold/60 uppercase tracking-[0.4em] mb-4 border-b border-gold/10 pb-2">Chapitre VII</h2>
                  <h3 className="text-base font-headline text-[#4a3721] mb-6 tracking-tight">L'Alliance de la Lumière</h3>
                  <p className="text-[#3d2b19] first-letter:text-4xl first-letter:font-headline first-letter:mr-3 first-letter:float-left first-letter:text-gold first-letter:leading-none font-serif leading-relaxed text-justify text-[11px] italic">
              ...
              <Page number={9}>
                <div className="px-6">
                  <h2 className="text-[9px] font-headline text-gold/60 uppercase tracking-[0.4em] mb-4 border-b border-gold/10 pb-2">Chapitre VIII</h2>
                  <h3 className="text-base font-headline text-[#4a3721] mb-6 tracking-tight">Le Crépuscule des Cavaliers</h3>
                  <p className="text-[#3d2b19] first-letter:text-4xl first-letter:font-headline first-letter:mr-3 first-letter:float-left first-letter:text-gold first-letter:leading-none font-serif leading-relaxed text-justify text-[11px] italic">
              ...
              <Page number={10}>
                <div className="px-6">
                  <h2 className="text-[9px] font-headline text-gold/60 uppercase tracking-[0.4em] mb-4 border-b border-gold/10 pb-2">Chapitre IX</h2>
                  <h3 className="text-base font-headline text-[#4a3721] mb-6 tracking-tight">Le Nouvel Équilibre</h3>
                  <p className="text-[#3d2b19] first-letter:text-4xl first-letter:font-headline first-letter:mr-3 first-letter:float-left first-letter:text-gold first-letter:leading-none font-serif leading-relaxed text-justify text-[11px] italic">
