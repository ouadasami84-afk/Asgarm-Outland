    ...
    <div className="page" ref={ref}>
      <div className="page-content">
        ...
        >
          {children}
          {number && (
            <div className="page-footer font-serif italic text-[#4a3721]/30 text-[10px] tracking-[0.6em] mt-auto pt-8 text-center">
              — {number} —
            </div>
          )}
        </motion.div>
        ...
        >
          ...
          <div className="flip-book-container relative shadow-[0_60px_120px_rgba(0,0,0,1)] border-[2px] border-[#1a120a] rounded-sm overflow-hidden bg-[#2a1a0a]">
            ...
            >
              {/* Chapitre 1 */}
              <Page number={1}>
                <h2 className="text-2xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-12 text-center border-b border-[#4a3721]/10 pb-6">Chapitre 1</h2>
              ...
              {/* Chapitre 2 */}
              <Page number={2}>
                <h2 className="text-2xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-12 text-center border-b border-[#4a3721]/10 pb-6">Chapitre 2</h2>
                <p className="text-[#3d2b19] first-letter:text-7xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-loose text-justify text-lg">
              ...
              {/* Chapitre 3 */}
              <Page number={3}>
                <h2 className="text-2xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-12 text-center border-b border-[#4a3721]/10 pb-6">Chapitre 3</h2>
                <p className="text-[#3d2b19] first-letter:text-7xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-loose text-justify text-lg">
              ...
              {/* Chapitre 4 */}
              <Page number={4}>
                <h2 className="text-2xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-12 text-center border-b border-[#4a3721]/10 pb-6">Chapitre 4</h2>
                <p className="text-[#3d2b19] first-letter:text-7xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-loose text-justify text-lg">
              ...
              {/* Chapitre 5 */}
              <Page number={5}>
                <h2 className="text-2xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-12 text-center border-b border-[#4a3721]/10 pb-6">Chapitre 5</h2>
                <p className="text-[#3d2b19] first-letter:text-7xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-loose text-justify text-lg">
              ...
              {/* Chapitre 6 */}
              <Page number={6}>
                <h2 className="text-2xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-12 text-center border-b border-[#4a3721]/10 pb-6">Chapitre 6</h2>
                <p className="text-[#3d2b19] first-letter:text-7xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-loose text-justify text-lg">
              ...
              {/* Chapitre 7 */}
              <Page number={7}>
                <h2 className="text-2xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-12 text-center border-b border-[#4a3721]/10 pb-6">Chapitre 7</h2>
                <p className="text-[#3d2b19] first-letter:text-7xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-loose text-justify text-lg">
              ...
              {/* Chapitre 8 */}
              <Page number={8}>
                <h2 className="text-2xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-12 text-center border-b border-[#4a3721]/10 pb-6">Chapitre 8</h2>
                <p className="text-[#3d2b19] first-letter:text-7xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-loose text-justify text-lg">
              ...
              {/* Chapitre 9 */}
              <Page number={9}>
                <h2 className="text-2xl font-headline text-[#4a3721] uppercase tracking-[0.5em] mb-12 text-center border-b border-[#4a3721]/10 pb-6">Chapitre 9</h2>
                <p className="text-[#3d2b19] first-letter:text-7xl first-letter:font-headline first-letter:mr-4 first-letter:float-left first-letter:text-[#4a3721] first-letter:leading-none font-serif leading-loose text-justify text-lg">
